...
static inline uint64_t tdx_seamcall(u64 op, u64 rcx, u64 rdx, u64 r8,
...
static inline u64 tdh_mng_addcx(hpa_t tdr, hpa_t addr)
{
	...
	r = tdx_seamcall(TDH_MNG_ADDCX, addr,
				   ...
				   hpa_t source, struct tdx_module_output *out)
{
	...
	r = tdx_seamcall(TDH_MEM_PAGE_ADD,
				   ...
				   struct tdx_module_output *out)
{
	...
	r = tdx_seamcall(TDH_MEM_SEPT_ADD,
...
static inline u64 tdh_mem_sept_remove(hpa_t tdr, gpa_t gpa, int level,
				      struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MEM_SEPT_REMOVE,
					...
					struct tdx_module_output *out)
{
	...
	return tdx_seamcall(TDH_MEM_PAGE_RELOCATE,
				   ...
				   struct tdx_module_output *out)
{
	...
	tdx_clflush_page(hpa, tdx_sept_level_to_pg_level(level));
	r = tdx_seamcall(TDH_MEM_PAGE_AUG,
				      ...
				      struct tdx_module_output *out)
{
	 ...
	 */
	return tdx_seamcall(TDH_MEM_RANGE_BLOCK,
			    gpa | level, tdr, 0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_mng_key_config(hpa_t tdr)
{
	return tdx_seamcall(TDH_MNG_KEY_CONFIG,
				      ...
				      struct tdx_module_output *out)
{
	...
	tdx_clflush_page(page, PG_LEVEL_4K);
	r = tdx_seamcall(TDH_MEM_PAGE_DEMOTE,
			 gpa | level, tdr, page, 0, 0, 0, 0, 0, out);
	if (!r)
		tdx_set_page_np(page);
	return r;
...
static inline u64 tdh_mem_page_promote(hpa_t tdr, gpa_t gpa, int level,
				       struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MEM_PAGE_PROMOTE,
			    gpa | level, tdr, 0, 0, 0, 0, 0, 0, out);
}
...
static inline u64 tdh_mr_extend(hpa_t tdr, gpa_t gpa,
				struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MR_EXTEND,
			    gpa, tdr, 0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_mr_finalize(hpa_t tdr)
{
	return tdx_seamcall(TDH_MR_FINALIZE,
			    tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_vp_flush(hpa_t tdvpr)
{
	return tdx_seamcall(TDH_VP_FLUSH,
			    tdvpr, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_mng_vpflushdone(hpa_t tdr)
{
	return tdx_seamcall(TDH_MNG_VPFLUSHDONE,
			    tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_mng_key_freeid(hpa_t tdr)
{
	return tdx_seamcall(TDH_MNG_KEY_FREEID,
			    tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}
...
static inline u64 tdh_mng_init(hpa_t tdr, hpa_t td_params,
			       struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MNG_INIT,
			    tdr, td_params, 0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_vp_init(hpa_t tdvpr, u64 rcx)
{
	return tdx_seamcall(TDH_VP_INIT, tdvpr, rcx, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_vp_rd(hpa_t tdvpr, u64 field,
			    struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_VP_RD,
			    tdvpr, field, 0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_mng_key_reclaimid(hpa_t tdr)
{
	return tdx_seamcall(TDH_MNG_KEY_RECLAIMID,
			    tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}
...
static inline u64 tdh_phymem_page_reclaim(hpa_t page,
					  struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_PHYMEM_PAGE_RECLAIM,
...
static inline u64 tdh_mem_page_remove(hpa_t tdr, gpa_t gpa, int level,
				      struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MEM_PAGE_REMOVE,
			    gpa | level, tdr, 0, 0, 0, 0, 0, 0, out);
}
...
{
	return tdx_seamcall(TDH_SYS_LP_SHUTDOWN, 0, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_mem_track(hpa_t tdr)
{
	return tdx_seamcall(TDH_MEM_TRACK, tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_mem_range_unblock(hpa_t tdr, gpa_t gpa, int level,
					struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_MEM_RANGE_UNBLOCK,
			    gpa | level, tdr, 0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_phymem_cache_wb(bool resume)
{
	return tdx_seamcall(TDH_PHYMEM_CACHE_WB,
			    resume ? 1 : 0, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_phymem_page_wbinvd(hpa_t page)
{
	return tdx_seamcall(TDH_PHYMEM_PAGE_WBINVD,
...
static inline u64 tdh_export_unblockw(hpa_t tdr,
				      ...
				      struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_EXPORT_UNBLOCKW, ept_info, tdr,
			    0, 0, 0, 0, 0, 0, out);
}
...
static inline u64 tdh_export_mem(hpa_t tdr,
				 ...
				 struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_EXPORT_MEM, gpa_list_info, tdr, mbmd_info,
...
static inline u64 tdh_import_mem(hpa_t tdr,
				 ...
				 struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_IMPORT_MEM, gpa_list_info, tdr, mbmd_info,
			    buf_list_info, mig_stream_info, mac_list0_info,
...
{
	return tdx_seamcall(TDH_IMPORT_COMMIT, tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}

static inline u64 tdh_export_pasue(hpa_t tdr)
{
	return tdx_seamcall(TDH_EXPORT_PAUSE, tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}
...
static inline u64 tdh_export_restore(hpa_t tdr,
				     ...
				     struct tdx_module_output *out)
{
	return tdx_seamcall(TDH_EXPORT_RESTORE, gpa_list_info, tdr,
			    0, 0, 0, 0, 0, 0, out);
}

static inline u64 tdh_import_end(hpa_t tdr)
{
	return tdx_seamcall(TDH_IMPORT_END, tdr, 0, 0, 0, 0, 0, 0, 0, NULL);
}
